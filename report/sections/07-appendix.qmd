...
The three weather zones are centered on the downtown core (41.886$^\circ$N, 87.629$^\circ$W), the O'Hare area (41.979$^\circ$N, 87.903$^\circ$W), and the South Side (41.785$^\circ$N, 87.750$^\circ$W). Both the elbow method and the silhouette score pointed to k = 3. @tbl-weather-vars lists the hourly variables fetched for each zone.
...
| Large (resolution 5, 8 cells) | 8 hours | 116.64 | 0.944 |
| Medium (resolution 6, 27 cells) | 1 hour | 8.18 | 0.889 |
| Medium (resolution 6, 27 cells) | 4 hours | 31.10 | 0.902 |
| Medium (resolution 6, 27 cells) | 8 hours | 45.73 | 0.948 |
| Fine (resolution 7, 128 cells) | 1 hour | 2.98 | 0.790 |
| Fine (resolution 7, 128 cells) | 4 hours | 9.50 | 0.842 |
| Fine (resolution 7, 128 cells) | 8 hours | 12.69 | 0.886 |
...
The grid search covers hidden layer sizes ([64, 64], [128, 64], [256, 256] and [64, 64, 64, 64]), dropout (0 %, 10 %), learning rate (0.1, 0.01, 0.001) and optimizer (SGD, Adam). Each candidate trains for up to 200 iterations, stopping early after 20 iterations without validation improvement. The winning configuration (two hidden layers of 256 neurons each, no dropout, learning rate 0.001, Adam) is retrained from scratch on the combined training and validation data.
