...
![H3 hexagonal grid overlaid on Chicago community areas at resolutions 6, 7, and 8.](assets/h3_grid_chicago.png){width=90% fig-align="center"}

![Distribution of trip duration, distance, fare, tips, total cost, and inter-trip idle time across the full dataset. Distributions are clipped at the 99th percentile so airport flat rates and exceptional idle gaps don't distort the axes.](assets/trip_metric_distributions.png){width=90% fig-align="center"}

![Pickup demand by 4-hour time bucket, covering the full 24-hour cycle.](assets/demand_4h_buckets.png){width=90% fig-align="center"}
...
![Choropleth maps of fare/mile, aggregated by hexagon resolutions 7 on 4 hour buckets](assets/fare_efficiency_rank_mile_4h.png){width=80% fig-align="center"}

![Choropleth maps of fare/min, aggregated by hexagon resolutions 7 on 4 hour buckets](assets/fare_efficiency_rank_min_4h.png){width=80% fig-align="center"}

![Origin--destination matrix for the top 10 community areas by total trip volume.](assets/od_matrix_community.png){width=90% fig-align="center"}
